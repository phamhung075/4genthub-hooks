...
### ✨ Submodule Compatibility (New 2025!)
...
├── .git
├── .mcp.json             ← Place config here
├── CLAUDE.md             ← Place team rules here
├── CLAUDE.local.md       ← Place personal settings here
└── .claude/              ← Submodule (4genthub-hooks)
    ├── hooks/
    │   └── session_start.py  (automatically finds ../../../.mcp.json)
