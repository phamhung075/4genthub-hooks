...
def scan_ai_docs(ai_docs_path):
    ...
    index = {
        ...
        "total_directories": 0,
        "categories": {},
        "absolute_docs": {"tracked_files": {}, "obsolete_docs": []},
        "structure": {},
    }
    ...
    try:
        ...
        try:
            ...
            doc_path = (
                ai_docs_path
                / "_absolute_docs"
                / file_path.parent.relative_to(actual_root)
                / doc_name
            )
        except:
...
if __name__ == "__main__":
    ...
    print(
        f"Index updated: {index['total_files']} files in {index['total_directories']} directories"
    )
